...
class Academy  {
    ...
    printStudents = function name(params) {};
    printSubjects = function name(params) {};
}
...
class Subject  {
    ...
    overRideClasses = function name(params) {};
}
...
class Student  {
    ...
    academy = null;
    currentSubject = null;
    startAcademy = function name(params) {};
    startSubject = function name(params) {};
}